...
export const ACCESS_BASE: AccessBase[] = [
  ...
  { name: 'Emili Zepeda Duenas', passes: 2, table: 3, code: '132' },
  ...
  { name: 'Yaneth Fuentes Reynaga', passes: 1, table: 4, code: '244' },
  { name: 'Maria de Jesus Fuentes', passes: 1, table: 4, code: '142' },
  ...
  { name: 'Angelica y Zory Contreras', passes: 2, table: 5, code: '251' },
  ...
  { name: 'Gemma Morfin', passes: 1, table: 5, code: '158' },
  { name: 'Amaranta Romero', passes: 2, table: 6, code: '261' },
  { name: 'Lizbeth Cardenas', passes: 2, table: 6, code: '161' },
  { name: 'Antonio Izquierdo', passes: 1, table: 6, code: '162' },
  { name: 'Zerlina Arroyo', passes: 1, table: 6, code: '163' },
  { name: 'Jose Ruiz Contreras', passes: 1, table: 6, code: '164' },
  { name: 'Socorro Salazar Ramos', passes: 3, table: 6, code: '361' },
  { name: 'Julio Barajas', passes: 1, table: 10, code: '165' },
  ...
  { name: 'Pedro Campos', passes: 1, table: 7, code: '174' },
  { name: 'Gerardo Madrigal Murillo', passes: 1, table: 7, code: '175' },
  { name: 'Alberto Vargas', passes: 2, table: 7, code: '272' },
  { name: 'Irvin Paul Fuentes', passes: 2, table: 12, code: '273' },
  { name: 'America Pimentel', passes: 1, table: 7, code: '274' },
  { name: 'Tania Murillo', passes: 1, table: 8, code: '281' },
  ...
  { name: 'Carlos Villegas', passes: 1, table: 8, code: '285' },
  { name: 'Alfredo Hueramo', passes: 1, table: 8, code: '287' },
  { name: 'Nayeli Hurtado', passes: 1, table: 8, code: '286' },
  ...
  { name: 'Celia Campos', passes: 2, table: 11, code: '215' },
  { name: 'Yaritza Rodríguez', passes: 2, table: 11, code: '216' },
  { name: 'Sara Peñaloza', passes: 3, table: 12, code: '321' },
  { name: 'Pechan Cuevas', passes: 1, table: 12, code: '124' },
  { name: 'Rodain Trejo', passes: 1, table: 12, code: '125' },
  { name: 'Jonathan Jair', passes: 1, table: 10, code: '126' },
  { name: 'Fernando Vargas', passes: 1, table: 10, code: '127' },
