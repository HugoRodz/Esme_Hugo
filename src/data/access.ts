...
export const ACCESS_BASE: AccessBase[] = [
  ...
  { name: 'Irvin Paul Fuentes Quiones', passes: 1, table: 2, code: '121' },
  ...
  { name: 'Telus', passes: 2, table: 9, code: '293' },
  { name: 'Israel Calderon', passes: 2, table: 9, code: '294' },
  { name: 'Naviel Berber', passes: 2, table: 10, code: '201' },
